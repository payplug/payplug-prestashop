...
class AdminClass
{
    ...
    public function adminAjaxController()
    {
        ...
        if ($this->tools->tool('getValue', 'rest_route') == '/payplug_api/logout') {
        ...
        if ((int) $this->tools->tool('getValue', 'checkPremium') == 1 && $this->tools->tool('getValue', 'email')) {
    ...
    "logged": {
      ...
      "inactive_account": {
        "warning": {
          ...
          "description": "While your application is being reviewed, you can use the TEST mode to discover our module. Click here to switch to LIVE mode and collect payments from your customers."
        },
        "error": {
