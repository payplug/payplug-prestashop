...
class ConfigClass
{
    ...
    public function __construct($dependencies)
    {
        ...
        if (file_exists(dirname(__FILE__)."/../features.json")) {
            $this->features_json = json_decode($this->tools->tool('getValue', dirname(__FILE__)."/../features.json"));
        } else {
            $this->features_json = [];
        }
    }
    ...
    public function isMobiledevice()
    {
        ...
        if (preg_match($reg1, $useragent) || preg_match($reg2, $this->tools->tool('substr', $useragent, 0, 4))) {
            return true;
        }
        return false;
    }
