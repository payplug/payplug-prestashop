...
//                @todo Add Log
        ...
        $this->context->smarty->assign([
            ...
            'feature_sandbox_mode' => $configurations['sandbox_mode'],
            'feature_embedded_mode' => $configurations['embedded_mode'],
            'feature_one_click' => $configurations['one_click'],
            'feature_standard' => $configurations['standard'],
            'feature_inst' => $configurations['inst'],
            'feature_inst_mode' => $configurations['inst_mode'],
            'feature_inst_min_amount' => $configurations['inst_min_amount'],
            'feature_show' => $configurations['show'],
            'feature_debug_mode' => $configurations['debug_mode'],
            'feature_deferred' => $configurations['deferred'],
