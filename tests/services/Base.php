...
namespace PayPlugModule\tests\services;
...
//    protected $amountCurrencyClass_static;
    ...
    private function setRepository()
    {
        ...
        $this->logger               = MockHelper::createMockFactory('PayPlugModule\src\services\Logger');
        $this->query                = MockHelper::createQueryMock('PayPlugModule\src\services\Query');
        $this->sql                  = MockHelper::createMockFactory('PayPlugModule\src\services\SQLtable');
    }
