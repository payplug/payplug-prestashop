...
use PayPlugModule\src\services\Query;
use PayPlugModule\src\services\Translations;
use PayPlugModule\src\services\SQLtable;
use PayPlugModule\src\services\Card;
use PayPlugModule\src\services\Hook;
use PayPlugModule\src\services\Cache;
use PayPlugModule\src\services\Oney;
use PayPlugModule\src\services\OrderState;
use PayPlugModule\src\services\Install;
use PayPlugModule\src\services\Service;

use PayPlugModule\src\services\Payment;
...
class PluginConstructor extends Service
{
...
//            ->setInstallment($this->installment)
    ...
    private function setRepositories()
    {
        ...
        $this->order_state = new OrderState(
            $this->configuration,
            $this->constant,
            $this->dependencies,
            $this->language,
