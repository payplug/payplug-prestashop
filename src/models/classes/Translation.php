        ...
        return [
            ...
            'premium' => [
                ...
                'feature' => [
                    ...
                    'giropay' => $this->dependencies->l('modal.premium.feature.giropay', 'modaltranslation'),
                    'ideal' => $this->dependencies->l('modal.premium.feature.ideal', 'modaltranslation'),
                    'mybank' => $this->dependencies->l('modal.premium.feature.mybank', 'modaltranslation'),
                    'satispay' => $this->dependencies->l('modal.premium.feature.satispay', 'modaltranslation'),
                    'sofort' => $this->dependencies->l('modal.premium.feature.sofort', 'modaltranslation'),
                ],
