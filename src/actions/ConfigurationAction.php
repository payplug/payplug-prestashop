...
class ConfigurationAction
{
    ...
    public function saveAction($datas = null)
    {
        ...
        if (isset($datas->enable_scalapay, $datas->scalapay_min_amounts, $datas->scalapay_max_amounts)
            ...
            $scalapay_min = (int) $amount_helper->convertAmount($datas->scalapay_min_amounts);
            $scalapay_max = (int) $amount_helper->convertAmount($datas->scalapay_max_amounts);
            ...
            if (isset($datas->{$config})) {
                ...
                switch ($config) {
                    ...
                    case 'scalapay_max_amounts':
                        // Already validated against the account's authorized range above.
