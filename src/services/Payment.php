...
namespace PayPlugModule\src\services;
...
class Payment extends Service
{
    ...
    public function createPayment($paymentDetails)
    {
        ...
        if ($paymentDetails['paymentMethod'] !== 'installment') {
            try {
                if ($apiPayment = PaymentLib::create($paymentDetails['paymentTab'])) {
    ...
    public function isValidApiPayment($paymentDetails)
    {
        ...
        $retrievedPayment = PaymentLib::retrieve($storedPayment['id_payment']);
