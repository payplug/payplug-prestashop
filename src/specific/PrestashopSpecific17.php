...
class PrestashopSpecific17
{
    ...
    {
        $this->payplug->addCSS(__PS_BASE_URI__ . 'modules/payplug/views/css/admin_order.css');
        $this->payplug->addJS(__PS_BASE_URI__ . 'modules/payplug/views/js/admin_order.js');
    }
}
