...
class PrestashopSpecific17
{
    ...
    {
        $this->payplug->addCSSRC(__PS_BASE_URI__ . 'modules/payplug/views/css/front-v3.2.0.css');
        $this->payplug->addJsRC(__PS_BASE_URI__ . 'modules/payplug/views/js/front-v3.2.0.js');
    }
