...
class PrestashopSpecific17
{
    ...
    {
        $this->payplug->addCSSRC(__PS_BASE_URI__ . 'modules/payplug/views/css/front_3.1.0.css');
        $this->payplug->addJsRC(__PS_BASE_URI__ . 'modules/payplug/views/js/front_3.1.0.js');
    }
