...
class PrestashopSpecific17
{
    ...
    {
        $this->payplug->addCSSRC(__PS_BASE_URI__ . 'modules/payplug/views/css/front-v3.1.2.css');
        $this->payplug->addJsRC(__PS_BASE_URI__ . 'modules/payplug/views/js/front-v3.1.2.js');
    }
