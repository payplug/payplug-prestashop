...
*}
{* paylater Block *}
{capture assign="paylaterBlock_title"}
    {l s='paylater.block.title' mod={$module_name}}
{/capture}
{capture assign="payLaterBlock_description"}
    {l s='paylater.block.description' mod={$module_name}}
{/capture}
{capture assign="detailsTitle"}
    {l s='paylater.block.detailsTitle' mod={$module_name}}
{/capture}
{capture assign='faq_oneyBlock'}
    ...
    linkNoTag=true}
{/capture}
{capture assign="detailsDescription"}
    {l s='paylater.block.detailsDescription' tags=[$faq_oneyBlock] mod={$module_name}}
{/capture}
{capture assign="oneyWithFeesTitle"}
    {l s='paylater.block.oneyWithFeesTitle' mod={$module_name}}
{/capture}
{capture assign="oneyWithoutFeesTitle"}
    {l s='paylater.block.oneyWithoutFeesTitle' mod={$module_name}}
{/capture}
{capture assign="oneyWithFeesDescription"}
    {l s='paylater.block.oneyWithFeesDescription' mod={$module_name}}
{/capture}
{capture assign="oneyWithoutFeesDescription"}
    {l s='paylater.block.oneyWithoutFeesDescription' mod={$module_name}}
{/capture}
...
{capture assign="paylaterBlock_content"}
    ...
    <div class="_details">
        ...
        <div class="_detailsSwitch">{if $module_name=='pspaylater'}
