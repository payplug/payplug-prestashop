...
<div class="panel-row separate_margin_block">
    <div class="{$module_name|escape:'htmlall':'UTF-8'}Panel">
        <div class="{$module_name|escape:'htmlall':'UTF-8'}Panel_label">{l s='Payment page' mod='payplug'}</div>
        <div class="{$module_name|escape:'htmlall':'UTF-8'}Panel_content">
            {if isset($payplug_switch.embedded.format) && $integrated && $standard_isActivated}
                <div class="{$module_name|escape:'htmlall':'UTF-8'}Switch
                    ...
                    {if isset($payplug_switch.embedded.label_left) && $payplug_switch.embedded.label_left}<label for="{$payplug_switch.embedded.name|escape:'htmlall':'UTF-8'}_left" class="{$module_name|escape:'htmlall':'UTF-8'}Switch_label -left">{$payplug_switch.embedded.label_left|escape:'htmlall':'UTF-8'}</label>{/if}
                    ...
                    {if isset($payplug_switch.embedded.label_center) && $payplug_switch.embedded.label_center}<label for="{$payplug_switch.embedded.name|escape:'htmlall':'UTF-8'}_center" class="{$module_name|escape:'htmlall':'UTF-8'}Switch_label -center">{$payplug_switch.embedded.label_center|escape:'htmlall':'UTF-8'}</label>{/if}
                    ...
                    {if isset($payplug_switch.embedded.label_right) && $payplug_switch.embedded.label_right}<label for="{$payplug_switch.embedded.name|escape:'htmlall':'UTF-8'}_right" class="{$module_name|escape:'htmlall':'UTF-8'}Switch_label -right">{$payplug_switch.embedded.label_right|escape:'htmlall':'UTF-8'}</label>{/if}
                </div>
            {else}
                <div class="{$module_name|escape:'htmlall':'UTF-8'}Switch
    ...
    <div class="{$module_name|escape:'htmlall':'UTF-8'}Panel">
        <div class="{$module_name|escape:'htmlall':'UTF-8'}Panel_content">
            <div class="{$module_name|escape:'htmlall':'UTF-8'}Tips -{$payplug_switch.embedded.name|escape:'htmlall':'UTF-8'}">
                {if isset($payplug_switch.embedded.format) && $integrated }
                    <div class="{$module_name|escape:'htmlall':'UTF-8'}Tips_item -left {if $payplug_switch.embedded.checked !== 'integrated'}-hide{/if}">
                        {l s='admin.panel.settings.embedded.integrated' mod='payplug'}
                        <a class="{$module_name|escape:'htmlall':'UTF-8'}Link" href="{$faq_links.support|escape:'htmlall':'UTF-8'}" data-e2e-link="faq" target="_blank">{l s='admin.panel.settings.embedded.learnmore' mod='payplug'}</a>
                    </div>
                {/if}
                    <div class="{$module_name|escape:'htmlall':'UTF-8'}Tips_item {if isset($payplug_switch.embedded.format) && $integrated}-center{else}-left{/if} {if $payplug_switch.embedded.checked != 'popup'}-hide{/if}">
                        {l s='admin.panel.settings.embedded.popup' tags=[$paymentPagePersoPopup] mod='payplug'}
                        <a class="{$module_name|escape:'htmlall':'UTF-8'}Link" href="{$faq_links.support|escape:'htmlall':'UTF-8'}" data-e2e-link="faq" target="_blank">{l s='admin.panel.settings.embedded.learnmore' mod='payplug'}</a>
                    </div>
                    <div class="{$module_name|escape:'htmlall':'UTF-8'}Tips_item -right {if $payplug_switch.embedded.checked != 'redirected'}-hide{/if}">
