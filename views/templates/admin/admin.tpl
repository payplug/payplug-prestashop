...
<script type="text/javascript" src="{$lib_path|escape:'htmlall':'UTF-8'}js/app-1.3.0.js"></script>
<script type="text/javascript" src="{$lib_path|escape:'htmlall':'UTF-8'}js/chunk-vendors-1.3.0.js"></script>