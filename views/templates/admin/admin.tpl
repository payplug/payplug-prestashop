...
<div class="panel payplugUIComponent">
    ...
    <link rel="stylesheet" href="/modules/payplug/views/css/components/atoms/title.css">
    ...
    <link rel="stylesheet" href="/modules/payplug/views/css/components/atoms/buttonLink.css">
