...
<div class="{$module_name|escape:'htmlall':'UTF-8'}Configuration">
    <div class="{$module_name|escape:'htmlall':'UTF-8'}">
        ...
        <p class="{$module_name|escape:'htmlall':'UTF-8'}Interpanel {$module_name|escape:'htmlall':'UTF-8'}Alert -success">
            <span>
                {l s='For more information about installing and configuring the plugin, please consult' mod='payplug'}
                <a class="{$module_name|escape:'htmlall':'UTF-8'}Link" href="{$faq_links.guide|escape:'htmlall':'UTF-8'}" data-e2e-link="faq" target="_blank">{l s='this support article' mod='payplug'}</a>.
            </span>
        </p>
