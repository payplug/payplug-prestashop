...
<script type="text/javascript" src="{$lib_url|escape:'htmlall':'UTF-8'}js/app-1.5.0.js"></script>
<script type="text/javascript" src="{$lib_url|escape:'htmlall':'UTF-8'}js/chunk-vendors-1.5.0.js"></script>