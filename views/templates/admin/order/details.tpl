...
<ul class="pp_payment_details">
    {if isset($payment.id)}
        <li>
            <span class="pp_col1">{l s='Transaction ID' mod={$module_name}} :</span>
            <span class="pp_col2" data-e2e-payment-details="id">{$payment.id|escape:'htmlall':'UTF-8'}</span>
        </li>
    {/if}
    {if isset($payment.type)}
        <li>
            <span class="pp_col1">{l s='Type' mod={$module_name}} :</span>
    ...
    {if isset($payment.status)}
        <li data-e2e-state_code="{$payment.status_code|escape:'htmlall':'UTF-8'}">
            <span class="pp_col1">{l s='Status' mod={$module_name}} :</span>
    ...
    {if isset($payment.amount)}
        <li>
            <span class="pp_col1">{l s='Amount' mod={$module_name}} :</span>
    ...
    {if isset($payment.authorization) && $payment.can_be_captured === true}
        {if isset($payment.date)}
            <li>
                <span class="pp_col1">{l s='Authorized on' mod={$module_name}} :</span>
    ...
    {else}
        {if isset($payment.date)}
            <li>
                <span class="pp_col1">{l s='Paid at' mod={$module_name}} :</span>
                <span class="pp_col2" data-e2e-payment-details="date">{$payment.date|escape:'htmlall':'UTF-8'}</span>
            </li>
        {/if}
    {/if}
    {if isset($payment.card_brand) && $payment.card_brand}
        <li>
            <span class="pp_col1">{l s='Credit card' mod={$module_name}} :</span>
    ...
    {if isset($payment.card_mask) && $payment.card_mask}
        <li>
            <span class="pp_col1">{l s='Card mask' mod={$module_name}} :</span>
    ...
    {if isset($payment.tds) && $payment.tds}
        <li>
            <span class="pp_col1">{l s='3-D Secure' mod={$module_name}} :</span>
    ...
    {if isset($payment.card_country) && ($payment.card_country) && isset($payment.type) && ($payment.type_code == 'bancontact')}
        <li>
            <span class="pp_col1">{l s='admin.details.country' mod={$module_name}} :</span>
    ...
    {if isset($payment.card_date) && $payment.card_date}
        <li>
            <span class="pp_col1">{l s='Expiry Date' mod={$module_name}} :</span>
    ...
    {if isset($payment.mode) && $payment.mode}
        <li>
            <span class="pp_col1">{l s='Mode' mod={$module_name}} :</span>
