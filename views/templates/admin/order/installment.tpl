...
<div class="table-responsive half-width">
    ...
    {if !$inst_paid}
        {if $inst_aborted}
            <input class="{$module_name|escape:'htmlall':'UTF-8'}Button -disabled" type="submit" name="submitPPAbort" value="{l s='Aborted' mod='payplug'}" disabled="disabled" />
        {elseif $inst_can_be_aborted}
            ...
            <input class="{$module_name|escape:'htmlall':'UTF-8'}Button -green" type="submit" name="submitPPAbort" value="{l s='Abort' mod='payplug'}"/>
        {/if}
        <br class="clear" />
    {/if}
</div>
