	...
	<div class="col-xs-12">
		{if isset($payplug_one_click) AND $payplug_one_click == 1}<div class="payplug-wrapper">{/if}
			<p class="payment_module">
				...
				{/if}
				<a class="payplug call{if isset($payplug_one_click) AND $payplug_one_click == 1} hide{/if}" title="{l s='Credit card payment' mod='payplug'}" href="{$this_path|escape:'htmlall':'UTF-8'}controllers/front/payment.php">
					{l s='Credit card checkout' mod='payplug'}
				</a>
