...
<div class="{$module_name}OneySchedule{if isset($use_fees) && !$use_fees} -withoutFees{/if}">
...
{if $language.iso_code == 'it' && $merchant_company_iso == 'IT'}
    <a href="https://www.payplug.com/hubfs/ONEY/payplug-italy{if isset($use_fees) && !$use_fees}-no-fees{/if}.pdf" target="_blank" class="{$module_name}OneyScheduleCGV">{l s='hook.oney.schedule.cgv' mod={$module_name}}</a>
{/if}
