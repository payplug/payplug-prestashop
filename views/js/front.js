    ...
    integrated: {
        ...
        set: function () {
            var integrated = payplugModule.integrated,
                ...
                $cvv = $form.find('.-cvv'),
                $exp = $form.find('.-exp'),
                intPayment = new Payplug.IntegratedPayment(payplug_public_key, $form.get(0))

            integrated.props.data = {
        ...
        pay: function () {
            var integrated = payplugModule.integrated,
                ...
                intPayment = props.data.intPayment;
            intPayment.pay(paymentId, Payplug.Scheme.AUTO, {save_card: false});
        }
    },
    card: {
        props: {
