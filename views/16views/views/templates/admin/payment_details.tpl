...
<ul class="pp_payment_details">
    ...
    {if isset($payment.authorization) && $payment.can_be_captured === true}
        ...
        {/if}
    {else}
        {if isset($payment.date) && $payment.paid}
            <li>
...
{/if}
{if isset($payment.can_be_cancelled) && $payment.can_be_cancelled === true}
    {include file=$payplug_module_dir|cat:'payplug/views/templates/admin/cancellation.tpl' payment=$payment}
{/if}
