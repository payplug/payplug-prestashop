    ...
    <div class="panel-row separate_margin_block">
        ...
        <div class="panel-row panel-oney pponeychecked">
            ...
            <div class="block-right">
                ...
                <span class="payplug_oney_tos_url_desc">{l s='I integrated the mandatory fields to my terms and conditions on my website.' mod='payplug'}
                    <a href="{$faq_links['oney']|escape:'htmlall':'UTF-8'}#h_f9ffbbdb-e5f2-487f-a709-854eb852e480"
                       target="_blank">{l s='Learn more.' mod='payplug'}</a>
                    <br />
                    <span id="tos_group" {if $payplug_oney_tos == 0} class="hide"{/if}>{l s='Please enter your General terms and conditions URL here: ' mod='payplug'}
                        <input  id="tos_url"
                                type="text"
                    ...
                    <br />
                    <span id="error_invalid_url" class="hide">{l s='Error : Please enter a valid URL.' mod='payplug'}</span>
                </span>
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="payplug_carrier_{$carrier->id|escape:'htmlall':'UTF-8'}_delivery_type">
                                    ...
                                    <option value="carrier"{if $carrier->delivery_type == 'carrier'} selected{/if}>{l s='Home Delivery' mod='payplug'}</option>
        ...
        <div class="panel-row panel-oney pponeychecked">
            ...
            <div class="block-right">
                ...
                <span class="oney-optimized"><strong>{l s='Go further' mod='payplug'}</strong>
                    ...
                    <a href="{$faq_links['oney']|escape:'htmlall':'UTF-8'}#h_2595dd3d-a281-43ab-a51a-4986fecde5ee"
                       target="_blank">{l s='Learn more.' mod='payplug'}</a>
                </span>
            </div>
        </div>
