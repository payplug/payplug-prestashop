...
<div class="panel-row separate_margin_block">
    {include file=$payplug_module_dir|cat:'payplug/views/templates/admin/switch.tpl' switch=$switch_deferred_payment}
    <div class="panel-row">
        <div class="block-right">
            <p class="pptips desc">{l s='Finalize payment later, when order has been shipped for instance. The funds will be blocked for a period of 7 days maximum once the payment has been authorized.' mod='payplug'}
                <a href="{$faq_links['deferred']|escape:'htmlall':'UTF-8'}" target="_blank">{l s='More information.' mod='payplug'}</a>
            </p>
        </div>
    </div>
